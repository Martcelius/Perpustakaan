                  ...
                  <form method="post" role="form" action="<?php echo base_url().'C_transaksi/cekpeminjaman' ?>">
                    <div class="box-body">
                      <!-- <div class="form-group">
                        ...
                        <input type="text" name="idpeminjaman" placeholder="ID Transaksi..." required> 
                        <input class="button" type="submit" name="cekidpeminjaman" value="Submit">   
                      <div class="form-group">
                        <label>ID Petugas</label>
                        <input type="text" class="form-control" name="id_petugas" placeholder="ID Petugas" readonly >
                      </div>
                      <div class="form-group">
                        <label>NIM Mahasisawa</label>
                        <input type="text" class="form-control" name="nim"  placeholder="NIM Mahasiswa"  readonly>
                      </div>
                      <div class="form-group">
                        <label>ID Buku</label>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="judul"  placeholder="Judul Buku"  readonly>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="tanggal" placeholder="Tanggal Peminjaman"   readonly>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <label>Denda</label>
                        <input type="text" class="form-control" name="denda" placeholder="Rp."  readonly>
                      </div>
                      <div class="form-group">
                        <label>Status</label>
