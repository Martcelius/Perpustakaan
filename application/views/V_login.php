                  ...
                  <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1">
                        ...
                        <strong>   Enter Details To Login </strong>  
                            ...
                            <div class="panel-body">
                                <form role="form" action="<?php echo base_url().'C_transaksi/login' ?>" method="post">
                                       <br />
                                    ...
                                    <div class="form-group">
                                     ...
                                     <a href="<?php echo base_url().'C_transaksi/login' ?>"><button type="submit" class="btn btn-danger btn-block btn-flat">Log In</button></a>
                                    <hr />
                                    </form>
                            </div>
